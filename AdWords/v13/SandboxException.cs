...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class SandboxException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public SandboxException(int errorCode) : base(errorCode) {
    }
    ...
    public SandboxException(int errorCode, string message) : base(errorCode, message) {
    }
