...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class InvalidRequestException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public InvalidRequestException(int errorCode) : base(errorCode) {
    }
    ...
    public InvalidRequestException(int errorCode, string message) : base(errorCode, message) {
    }
