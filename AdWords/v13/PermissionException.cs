...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class PermissionException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public PermissionException(int errorCode) : base(errorCode) {
    }
    ...
    public PermissionException(int errorCode, string message) : base(errorCode, message) {
    }
