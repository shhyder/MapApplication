...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class WebPageException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public WebPageException(int errorCode) : base(errorCode) {
    }
    ...
    public WebPageException(int errorCode, string message) : base(errorCode, message) {
    }
