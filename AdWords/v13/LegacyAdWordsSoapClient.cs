...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  public class LegacyAdWordsSoapClient : AdsSoapClient {
    /// <summary>
    /// An internal lookup map for storing error codes.
    /// </summary>
    private static Hashtable codeLookup = new Hashtable();

    /// <summary>
    /// Static constructor.
    /// </summary>
    static LegacyAdWordsSoapClient() {
      codeLookup.Add(
    ...
    protected override Exception GetCustomException(SoapException ex) {
      ...
      return new LegacyAdWordsApiException(-1,
          AdWordsErrorMessages.Unknownv13SoapExceptionOccurred, ex);
    }
  }
}
