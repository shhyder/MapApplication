...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class AccountException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public AccountException(int errorCode) : base(errorCode) {
    }
    ...
    public AccountException(int errorCode, string message) : base(errorCode, message) {
    }
