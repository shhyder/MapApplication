...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class BillingException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public BillingException(int errorCode) : base(errorCode) {
    }
    ...
    public BillingException(int errorCode, string message) : base(errorCode, message) {
    }
