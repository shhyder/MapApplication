...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class GoogleInternalException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public GoogleInternalException(int errorCode) : base(errorCode) {
    }
    ...
    public GoogleInternalException(int errorCode, string message) : base(errorCode, message) {
    }
