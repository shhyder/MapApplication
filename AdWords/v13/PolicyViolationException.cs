...
namespace Google.Api.Ads.AdWords.v13 {
  ...
  /// </summary>
  [Serializable]
  public class PolicyViolationException : LegacyAdWordsApiException {
    /// <summary>
    /// public constructor.
    /// </summary>
    /// <param name="errorCode">Error code for this API exception.</param>
    public PolicyViolationException(int errorCode) : base(errorCode) {
    }
    ...
    public PolicyViolationException(int errorCode, string message) : base(errorCode, message) {
    }
