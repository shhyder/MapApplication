...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="ProductList" >
     ...
     function GetList(page) {
         ...
         lastpage = page;
         jQuery.ajax({
         url: pfxURL.staticVar + "/Product/GetList/" + page,
             dataType: 'json',
             type: "POST",
             data: queryString,
 ...
 function OnNew() {
     ...
     $.get(pfxURL.staticVar + "/Product/New/" + id,
            NewProduct
            );
    ...
    function OnSave()
    {
         ...
         $.getJSON(pfxURL.staticVar + "/Product/Save", queryString, function(data) {
                    if( data.Has_Error )
                    {
    ...
    function OnEdit(productID ) {
     ...
     $.get(pfxURL.staticVar + "/Product/Edit/" + str ,
            EditProduct
            );
