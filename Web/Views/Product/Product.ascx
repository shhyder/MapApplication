...
<form id="formProduct" action="Upload" method="POST" enctype="multipart/form-data">
        ...
        <table border="0" style="width: 507px; border-top-style: none;" >
         ...
         <tr>
          <td class="style3"></td>
          <td class="style2 RTextAlign" >Code</td >
          <td class="style1">
        ...
        <tr>
          <td class="style3"></td>
          <td class="style2 RTextAlign" >Display Code</td>
          <td class="style1">
        ...
        <tr>
         ...
         <tr>
          <td class="style3"></td>
          <td class="style2 RTextAlign" >Product</td>
          <td class="style1">
        ...
        <tr>
         ...
         <tr>
          <td class="style4"></td>
          <td class="style5 RTextAlign">Type</td>
          <td class="style6">
        ...
        <tr>
          <td class="style3"></td>
          <td class="style2 RTextAlign">Description</td>
          <td class="style1" colspan="2">
                <textarea cols=10 rows=5   type="text"  name="txtDescription" style="width:380px" id="txtDescription" maxlength="550" value="<%= ViewData[UIProduct.txtDescription.ToString()].ToString()  %>"><%= ViewData[UIProduct.txtDescription.ToString()].ToString()  %></textarea>
          </td>
        </tr>
        <tr>
            <td class="style3" >&nbsp;</td>
        ...
        <tr>
          <td class="style3"></td>
          <td class="style2 RTextAlign" >Link</td>
          <td class="style1">
